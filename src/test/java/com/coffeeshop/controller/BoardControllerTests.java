...
import com.coffeeshop.config.ServletConfig;
...
public class BoardControllerTests {
	...
	public void testRegister() throws Exception {
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/board/register").param("title", "등록 테스트 제목")
						.param("content", "등록 테스트 내용").param("writer", "user00"))
...
/*
	...
	public void testModify() throws Exception {
		...
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/board/modify").param("bno", "21").param("title", "수정 테스트 제목")
						.param("content", "수정 테스트 내용").param("writer", "user00"))
				.andReturn().getModelAndView().getViewName();
